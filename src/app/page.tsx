        ...
        <div className="flex flex-col gap-4 h-full min-h-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 min-h-0">
            ...
            <div className="bg-stone-200 p-4 rounded-xl border-4 border-stone-300 h-full min-h-0 flex flex-col shadow-inner relative overflow-hidden">
              ...
              {/* Screws */}
              <div className="absolute top-2 left-2 w-3 h-3 rounded-full bg-stone-400 border border-stone-500 shadow-[inset_1px_1px_2px_rgba(0,0,0,0.5)] flex items-center justify-center">
                <div className="w-full h-[1px] bg-stone-600 rotate-45"></div>
              </div>
              <div className="absolute top-2 right-2 w-3 h-3 rounded-full bg-stone-400 border border-stone-500 shadow-[inset_1px_1px_2px_rgba(0,0,0,0.5)] flex items-center justify-center">
                <div className="w-full h-[1px] bg-stone-600 rotate-45"></div>
              </div>
              <div className="absolute bottom-2 left-2 w-3 h-3 rounded-full bg-stone-400 border border-stone-500 shadow-[inset_1px_1px_2px_rgba(0,0,0,0.5)] flex items-center justify-center">
                <div className="w-full h-[1px] bg-stone-600 rotate-45"></div>
              </div>
              <div className="absolute bottom-2 right-2 w-3 h-3 rounded-full bg-stone-400 border border-stone-500 shadow-[inset_1px_1px_2px_rgba(0,0,0,0.5)] flex items-center justify-center">
                <div className="w-full h-[1px] bg-stone-600 rotate-45"></div>
              </div>
              ...
              <Tabs defaultValue="filters" className="w-full flex-1 flex flex-col min-h-0 relative z-10">
                <TabsList className="w-full bg-stone-300/50 p-1 mb-4 h-9 shrink-0 border border-stone-400/30">
                  <TabsTrigger
                    value="filters"
                    className="flex-1 text-xs data-[state=active]:bg-stone-100 data-[state=active]:shadow-sm"
                  >
                    Filters
                  </TabsTrigger>
                  <TabsTrigger
